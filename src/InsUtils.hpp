...
std::pair<PointCloud2,visualization_msgs::Marker> converGrapp2MSG(const std::vector<Eigen::Vector3d> &nodes, 
...
visualization_msgs::Marker convertRelocalizationCorr2MSG(const std::pair<std::vector<Eigen::Vector3d>,std::vector<Eigen::Vector3d>> &corr_nodes, const Header &header){
...
visualization_msgs::Marker convertEdgeMsg(const std::vector<Eigen::Vector4d> &graph_nodes,
...
std::vector<geometry_msgs::Pose> loadPose(std::string file_pose){
